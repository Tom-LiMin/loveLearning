...
insert into `category` (id, parent, name, sort) values ('00000100', '00000000', 'Gundam 0079', 100);
insert into `category` (id, parent, name, sort) values ('00000101', '00000100', '阿姆罗', 101);
insert into `category` (id, parent, name, sort) values ('00000102', '00000100', '夏亚', 102);
insert into `category` (id, parent, name, sort) values ('00000103', '00000100', '塞拉', 103);
insert into `category` (id, parent, name, sort) values ('00000104', '00000100', '林有德', 104);
insert into `category` (id, parent, name, sort) values ('00000105', '00000100', '凯·西汀', 105);
insert into `category` (id, parent, name, sort) values ('00000106', '00000100', '小林隼', 106);
insert into `category` (id, parent, name, sort) values ('00000107', '00000100', '雷比尔', 107);
insert into `category` (id, parent, name, sort) values ('00000108', '00000100', '吉翁·戴肯', 108);
insert into `category` (id, parent, name, sort) values ('00000200', '00000000', 'Gundam 0083', 200);
insert into `category` (id, parent, name, sort) values ('00000201', '00000200', 'GP-01', 201);
insert into `category` (id, parent, name, sort) values ('00000202', '00000200', 'GP-02', 202);
insert into `category` (id, parent, name, sort) values ('00000203', '00000200', 'GP-03', 203);
insert into `category` (id, parent, name, sort) values ('00000204', '00000200', 'GP-04 石斛兰', 204);
insert into `category` (id, parent, name, sort) values ('00000205', '00000200', '飞马级“阿尔比昂”', 205);
insert into `category` (id, parent, name, sort) values ('00000206', '00000200', '提坦斯', 206);
insert into `category` (id, parent, name, sort) values ('00000300', '00000000', 'Gundam 0093', 300);
...
insert into `category` (id, parent, name, sort) values ('00000400', '00000000', 'Gundam 0105', 400);
...
insert into `category` (id, parent, name, sort) values ('00000500', '00000000', 'Gundam F91', 500);
...
insert into `category` (id, parent, name, sort) values ('00000600', '00000000', 'Turn A', 600);
...
insert into `category` (id, parent, name, sort) values ('00000700', '00000000', 'G-Self DataBase', 700);
